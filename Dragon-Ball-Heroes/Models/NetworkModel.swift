...
final class NetworkModel {
    ...
    // Singleton significa que esta instancio va a estar viva
    ...
    func login(user: String, password: String, completion: @escaping (Result<String,DragonBallError>) -> Void) {
        ...
        // Creamos un string vuyo formato sea %@:%@
        // Ej: usuario:contraseña
        let loginString = String(format: "%@:%@", user, password)
        // Encodificamos el login string
    ...
    func getHeroes(
       ...
       // Encoding el query item de url components
